...
from model import EGNNEnergyRegressor  # Change to EGNNFlavourClassifier or EGNNZenithRegressor as needed
from dataset import EGNNJUNODataset
...
def get_dataloaders(h5_path, edge_index, pos, stats, batch_size, val_split=0.2, limit=None, num_workers=2, target=None):
    dataset = EGNNJUNODataset(h5_path, edge_index=edge_index, pos=pos, stats=stats, limit=limit, target=target)
...
def main():
    ...
    # --- Data ---
    train_loader, val_loader = get_dataloaders(h5_path=h5_path, 
